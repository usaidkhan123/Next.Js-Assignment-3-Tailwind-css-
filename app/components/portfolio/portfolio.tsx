...
const PortFolio = () => {
    return (
        <div  className="h-[60rem]">
            ...
            <p className=" ml-28 ">is simply dummy text of the printing and typesetting industry. Lorem  <br />has been the industrys standard dummy text ever since the 1500s, when <br /> specimen book. It has survived not only five centuries,is simply dummy <br /> text of the printing and typesetting industry. Lorem  <br />has been the industrys standard dummy text ever since the 1500s, when <br /> specimen book. It has survived not only five centuries,</p>
